...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5539328,
    DYNAMIC_BASE = 5539328,
    DYNAMICTOP_PTR = 296416;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=296272;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 296320, 4), 296320);function _gmtime_r(time, tmPtr) {
